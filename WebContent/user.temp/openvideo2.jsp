			...
			<div class="show-top-grids">
				<div class="col-sm-8 single-left">
					<div class="song">
						...
						<div id="player"></div>
  <script>
    var player = new Clappr.Player({source: "https://s3-us-west-2.amazonaws.com/data-download-out/job2/hls_mycreation.m3u8", parentId: "#player"});
  </script>
					...
					<div class="all-comments">
						<div class="all-comments-info">
							...
							<div class="box">
								<form action="<%=request.getContextPath() %>/CommentController" method="post">
								<input type="hidden" name="flag" value="comment">
									<input type="text" placeholder="Name" required=" " name="name">			           					   
									<input type="text" placeholder="Email" required=" " name="email">
									
									<textarea placeholder="Message" name="c" required=" "></textarea>
