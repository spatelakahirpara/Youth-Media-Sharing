...
<title>admin-search subcategory</title>
</head>
<body>
    ...
    <div class="animsition">  
      ...
      <div id="logo-container">
        <a href="dashboard.html" id="logo-img">
          <img src="img/logo.png" class="big-logo" alt="SugarCrush">
          <img src="img/logo-mobile.png" data-no-retina  class="small-logo" alt="SugarCrush">
        </a>
      </div>
            ...
            <div class="col-md-12">
              ...
              <section class="panel panel-primary">
                <header class="panel-heading">
                  <h4 class="panel-title">Search subcategory</h4>
                </header>
                <div class="panel-body">
                  ...
                  <table class="table datatable">
                    ...
                    <tbody>
                     <c:forEach var="i" items="${sessionScope.subcategoryList1 }">
                      <tr>
                        <td>${i.subcat_id }</td>
                        <td>${i.subcat_name }</td>
                        <td>${i.categoryvo.cat_name}
                      </td>
                      
                        <td>${i.subcat_desc }</td>                                          
                        <td>
							<a class="delete-btn btn btn-xs btn-danger" href="<%=request.getContextPath()%>/SubCategoryController?flag=deleteSubCat&subcatId=${i.subcat_id }">delete</a>
