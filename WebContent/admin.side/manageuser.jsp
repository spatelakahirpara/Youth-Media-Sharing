              ...
              <section class="panel panel-primary">
                ...
                <div class="panel-body">
                  ...
                  <table class="table datatable">
                    ...
                    <tbody>
                    <c:forEach var="i" items="${sessionScope.l1 }">
                      <tr>
                        <td>${i.reg_id }</td>
                        <td>${i.user_name }</td>
                        <td>${i.email }</td>
                        <td>${i.password }</td>                        
                        <td><a class="btn btn-xs btn-primary" href="<%=request.getContextPath()%>/ManageUserController?flag=editUser&userId=${i.reg_id }">edit</a>
							<a class="delete-btn btn btn-xs btn-danger" href="<%=request.getContextPath()%>/ManageUserController?flag=deleteUser&userId=${i.reg_id }">delete</a>
