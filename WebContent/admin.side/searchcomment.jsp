...
<title>admin-search comment</title>
</head>
<body>
            ...
            <div class="col-md-12">
              ...
              <section class="panel panel-primary">
                <header class="panel-heading">
                  <h4 class="panel-title">Manage Comments</h4>
                </header>
                    ...
                    <tbody>
                     <c:forEach var="i" items="${sessionScope.List1}">
                      <tr>
						...
						<td><a class="delete-btn btn btn-xs btn-danger" href="<%=request.getContextPath()%>/CommentController?flag=deleteComment&commentId=${i.comment_id }">delete</a>
						</td>
                      </tr>
                      </c:forEach>
