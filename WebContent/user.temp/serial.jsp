...
<!---728x90--->
<div style="text-align: center;"><script async src="js/adsbygoogle.js"></script>
						...
						<div class="recommended-grids english-grid">
							...
							<div class="col-md-2 resent-grid recommended-grid show-video-grid">
								<div class="resent-grid-img recommended-grid-img">
									<a href="openvideo.jsp"><img src="images/eg1.jpg" alt="" /></a>
								...
								<div class="resent-grid-info recommended-grid-info">
									<h5><a href="openvideo.jsp" class="title">Varius sit sed Nullam interdum</a></h5>
							...
							<div class="col-md-2 resent-grid recommended-grid show-video-grid">
								<div class="resent-grid-img recommended-grid-img">
									<a href="openvideo2.jsp"><img src="images/eg2.jpg" alt="" /></a>
									<div class="time small-time show-time">
										<p>9:34</p>
									</div>
									<div class="clck show-clock">
								...
								<div class="resent-grid-info recommended-grid-info">
									<h5><a href="openvideo2.jsp" class="title">Varius sit sed Nullam interdum</a></h5>
									<p class="author"><a href="#" class="author">John Maniya</a></p>
							...
							<div class="col-md-2 resent-grid recommended-grid show-video-grid">
								<div class="resent-grid-img recommended-grid-img">
									<a href="openvideo3.jsp"><img src="images/eg3.jpg" alt="" /></a>
									<div class="time small-time show-time">
										<p>3:04</p>
									</div>
									<div class="clck show-clock">
								...
								<div class="resent-grid-info recommended-grid-info">
									<h5><a href="openvideo3.jsp" class="title">Varius sit sed Nullam interdum</a></h5>
									<p class="author"><a href="#" class="author">John Maniya</a></p>
							...
							<div class="col-md-2 resent-grid recommended-grid show-video-grid">
								<div class="resent-grid-img recommended-grid-img">
									<a href="openvideo4.jsp"><img src="images/eg4.jpg" alt="" /></a>
									<div class="time small-time show-time">
										<p>2:06</p>
									</div>
									<div class="clck show-clock">
								...
								<div class="resent-grid-info recommended-grid-info">
									<h5><a href="openvideo4.jsp" class="title">Varius sit sed Nullam interdum</a></h5>
									<p class="author"><a href="#" class="author">John Maniya</a></p>
