<div class="animsition">  
    ...
    <a id="logo-img" href="dashboard.jsp">
<img class="big-logo" alt="SugarCrush" src="img/logo-final.png">
<img class="small-logo" alt="SugarCrush" data-no-retina="" src="img/logo-mobile.png">
</a>
</div>
            ...
            <div class="collapse navbar-collapse" id="navbar-top">
              ...
              <div class="navbar-form navbar-left navbar-search-block">
                ...
                <div class="search-field-container">
                  <input type="text" placeholder="Search" class="search-field" style="width: 500px;">
              ...
              <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown user-profile">
                  <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">
                    ...
                    shruti<span class="chat-status success"></span>
                  </a>

                  <ul class="dropdown-menu" role="menu">
                    
                    <li><a href="../user.side/login.jsp">Logout</a></li>
                  </ul>
                </li>
                <!-- end of USER MENU -->
