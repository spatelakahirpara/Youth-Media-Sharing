 ...
 */
@WebServlet("/UploadServletMultiple1")
@MultipartConfig
public class UploadServletMultiple1 extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UploadServletMultiple1() {
        super();
		...
		for(Part filePart : request.getParts())
		{
			if(filePart.getSubmittedFileName()!=null && !filePart.getSubmittedFileName().equals(""))
			{
			   ...
			   File targetFile = new File(path1+fileName);
				...
				response.sendRedirect("FileUploadController");
