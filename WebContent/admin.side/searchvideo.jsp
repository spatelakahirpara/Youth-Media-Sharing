            ...
            <div class="col-md-12">
              ...
              <section class="panel panel-primary">
                <header class="panel-heading">
                  <h4 class="panel-title">Search video</h4>
                </header>
                  ...
                  <table class="table datatable">
                    ...
                    <c:forEach var="i" items="${sessionScope.List1}">
                      <tr>
                        ...
                        <td>${i.video_name }</td>
                        <td>${i.video_path }</td>
                        <td><a class="btn btn-xs btn-primary" href="<%=request.getContextPath()%>/SearchController?flag=makePublic&videoId=${i.video_id}">make Public</a>
                        <a class="delete-btn btn btn-xs btn-dangerh" href="<%=request.getContextPath()%>/SearchController?flag=makePublic&videoId=${i.video_id}">make private</a>
