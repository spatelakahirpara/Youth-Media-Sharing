...
<div class="all-comments">
							...
							<div class="box">
								...
								<input type="hidden" name="flag" value="feedback">
									<input type="text" placeholder="Name" required=" " name="name">			           					   
									<input type="text" placeholder="Feedback Title" required=" " name="title">
									
									<textarea placeholder="Feedback" name="f" required=" "></textarea>
