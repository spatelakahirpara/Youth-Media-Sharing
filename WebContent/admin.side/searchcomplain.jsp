...
<title>admin-search complain</title>
</head>
<body>
            ...
            <div class="col-md-12">
              ...
              <section class="panel panel-primary">
                <header class="panel-heading">
                  <h4 class="panel-title">Manage Complains</h4>
                </header>
                  ...
                  <table class="table datatable">
                    ...
                    <tbody>
                     <c:forEach var="i" items="${sessionScope.List1}">
                      <tr>
                        <td>${i.complainId }</td>
                        <td>${i.complainFrom.user_name}</td>
                        <td>${i.complainName}</td>
                        <td>${i.complainDescription}</td>
                        <td><a href="<%=request.getContextPath()%>/ComplainController?flag=replay&id=${i.complainId}" class="btn btn-xs btn-primary" href="#">Reply</a>
