...
public class HlsJobCreationSample {
    ...
    private static final String PIPELINE_ID = "1454072406804-s0yhvw";
    
    // This is the name of the input key that you would like to transcode.
    private static final String INPUT_KEY = "ETC ad.m4v";
    ...
    private static final String OUTPUT_KEY_PREFIX = "JobOutput/";
    ...
    private static final AmazonElasticTranscoder amazonElasticTranscoder = new AmazonElasticTranscoderClient(new BasicAWSCredentials("AKIAIH3H6SDPLN6IL5VA", "2xVZAF6f15rpRTLteMX6XasMBK2e180PguRN2Dak"));
    public static void main(String[] args) throws Exception {
    	
        amazonElasticTranscoder.setEndpoint("elastictranscoder.us-west-2.amazonaws.com");
